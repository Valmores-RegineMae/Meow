      ...
      <div class="row row-eq-height">
        ...
        <div class="col-lg-6">
          <div class="intro_image">
            <div class="background_image" style="background-image:url(images/FB22.jpg)"></div>
            <img src="images/FB22.jpg" alt="">
          </div>
        </div>
    ...
    <div class="container">
      ...
      <div class="row offering_row">
        ...
        <div class="col-xl-4 col-md-6">
          <div class="offer">
            <div class="offer_image"><img src="images/FB3.jpg" alt=""></div>
        ...
        <div class="col-xl-4 col-md-6">
          <div class="offer">
            <div class="offer_image"><img src="images/FB23.jpg" alt=""></div>
            <div class="offer_content text-center">
              <div class="offer_title"><h3>Indoor Bar</h3></div>
              <div class="offer_text">
          <!--      <p>Morbi tempus malesuada erat sed pellentesque. Donec pharetra mattis nulla, id laoreet neque scelerisque at. Quisque eget sem non ligula consectetur ultrices.</p>-->
              </div>
            <!--   <div class="offer_button"><a href="#">discover</a></div> -->
        ...
        <div class="col-xl-4 col-md-6">
          <div class="offer">
            <div class="offer_image"><img src="images/FB22.jpg" alt=""></div>
            <div class="offer_content text-center">
              <div class="offer_title"><h3>Living Area</h3></div>
              <div class="offer_text">
          <!--      <p>Morbi tempus malesuada erat sed pellentesque. Donec pharetra mattis nulla, id laoreet neque scelerisque at. Quisque eget sem non ligula consectetur ultrices.</p>-->
              </div>
            <!--   <div class="offer_button"><a href="#">discover</a></div> -->
        ...
        <div class="col-xl-4 col-md-6">
          <div class="offer">
            <div class="offer_image"><img src="images/FB34.jpg" alt=""></div>
            <div class="offer_content text-center">
              <div class="offer_title"><h3>Bonfire</h3></div>
              <div class="offer_text">
             <!--   <p>Morbi tempus malesuada erat sed pellentesque. Donec pharetra mattis nulla, id laoreet neque scelerisque at. Quisque eget sem non ligula consectetur ultrices.</p>-->
              </div>
            <!--   <div class="offer_button"><a href="#">discover</a></div> -->
        ...
        <div class="col-xl-4 col-md-6">
          <div class="offer">
            <div class="offer_image"><img src="images/FB6.jpg" alt=""></div>
            <div class="offer_content text-center">
              <div class="offer_title"><h3>Hammock</h3></div>
              <div class="offer_text">
            <!--    <p>Morbi tempus malesuada erat sed pellentesque. Donec pharetra mattis nulla, id laoreet neque scelerisque at. Quisque eget sem non ligula consectetur ultrices.</p>-->
              </div>
            <!--   <div class="offer_button"><a href="#">discover</a></div> -->
        ...
        <div class="col-xl-4 col-md-6">
          <div class="offer">
            <div class="offer_image"><img src="images/FB4.jpg" alt=""></div>
            <div class="offer_content text-center">
              <div class="offer_title"><h3>Beach House</h3></div>
              <div class="offer_text">
              <!--  <p>Morbi tempus malesuada erat sed pellentesque. Donec pharetra mattis nulla, id laoreet neque scelerisque at. Quisque eget sem non ligula consectetur ultrices.</p>-->
              </div>
            <!--   <div class="offer_button"><a href="#">discover</a></div> -->
