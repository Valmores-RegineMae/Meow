...
<form class="form-horizontal" action="PersonInfo.php" method="post"  name="personal" >    
				 ...
				 <div class="form-group">
			        <div class="col-md-12"> 
					 ...
					 <small>Agree the <a class="toggle-modal"  onclick="OpenPopupCenter('terms_condition.php','Terms And Codition','600','600')" /> TERMS AND CONDITION </a> of this Resort</small> 
                         ...
                         <div class="col-md-12">
					    	<input name="submit1" type="submit" value="Confirm"  class="btn btn-primary" onclick="return personalInfo();"/>
					    </div>
			    </div>
			 </div> 
		</form>   
